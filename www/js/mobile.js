...
function onDeviceReady() {
	...
	// var db = window.sqlitePlugin.openDatabase("MbeguChoice", "1.0", "mbeguchoicedb", 200000);
	...
	db.transaction(
		function(tx) {
			var creattablesql = "CREATE TABLE IF NOT EXISTS default_sid_institution ( "+
					...
					"institution_commagent varchar(255), " + 
					"institution_maintainer varchar(255), " + 
					"institution_breed varchar(255) " + 
				");";

			var populatetablesql = "INSERT OR IGNORE INTO default_sid_institution (institution_name, institution_id, institution_commagent, institution_maintainer, institution_breed) VALUES "+
				"(NULL, 1, 0, 0, 0),"+ 
				"('', 2, 0, 0, 0),"+
				"('AARDAPPELKWEEK', 3, 0, 0, 0),"+
				"('AFRICE SEED', 4, 0, 0, 0),"+
				"('AGRICO EAST AFRICA LTD.', 5, 0, 0, 0),"+
				"('AGRICULTURAL DEVELOPMENT CORPORATION', 6, 0, 0, 0),"+
				"('AGRISEED/SEED CO', 7, 0, 0, 0),"+
				"('ALPHEGA', 8, 0, 0, 0),"+
				"('BUBAYI SEED CO', 9, 0, 0, 0),"+
				"('CROP AFRICA', 10, 0, 0, 0),"+
				"('DEKALB', 11, 0, 0, 0),"+
				"('DEN HARTIGH BV', 12, 0, 0, 0),"+
				"('DRYLAND SEED LTD', 13, 0, 0, 0),"+
				"('EAST AFRICAN SEED CO LTD', 14, 0, 0, 0),"+
				"('EGERTON UNIVERSITY', 15, 0, 0, 0),"+
				"('ELGON KENYA LIMITED', 16, 0, 0, 0),"+
				"('ELGON KENYA LIMITED', 17, 0, 0, 0),"+
				"('FARMERS', 18, 0, 0, 0),"+
				"('FRESHCO KENYA LIMITED', 19, 0, 0, 0),"+
				"('GICHEHA', 20, 0, 0, 0),"+
				"('GNASS KENYA', 21, 0, 0, 0),"+
				"('GNASS KENYA', 22, 0, 0, 0),"+
				"('ICIPE', 23, 0, 0, 0),"+
				"('ICRISAT', 24, 0, 0, 0),"+
				"('IITA', 25, 0, 0, 0),"+
				"('INTERNATIONAL POTATO CENTER', 26, 0, 0, 0),"+
				"('KALRO', 27, 0, 0, 0),"+
				"('KALRO (MWEA & KIBOS)', 28, 0, 0, 0),"+
				"('KALRO EMBU', 29, 0, 0, 0),"+
				"('KALRO KAKAMEGA', 30, 0, 0, 0),"+
				"('KALRO KITALE', 31, 0, 0, 0),"+
				"('KALRO MUGUGA', 32, 0, 0, 0),"+
				"('KALRO SEED UNIT', 33, 0, 0, 0),"+
				"('KALRO-', 34, 0, 0, 0),"+
				"('KALRO- KAKAMEGA', 35, 0, 0, 0),"+
				"('KALRO- KATUMANI', 36, 0, 0, 0),"+
				"('KALRO- LANET', 37, 0, 0, 0),"+
				"('KALRO-EMBU', 38, 0, 0, 0),"+
				"('KALRO-KAKAMEGA', 39, 0, 0, 0),"+
				"('KALRO-KATUMANI', 40, 0, 0, 0),"+
				"('KALRO-KIBOS', 41, 0, 0, 0),"+
				"('KALRO-KITALE', 42, 0, 0, 0),"+
				"('KALRO-LANET', 43, 0, 0, 0),"+
				"('KALRO-MTWAPA', 44, 0, 0, 0),"+
				"('KALRO-MUGUGA', 45, 0, 0, 0),"+
				"('KALRO-MWEA', 46, 0, 0, 0),"+
				"('KALRO-NJORO', 47, 0, 0, 0),"+
				"('KALRO-TIGONI', 48, 0, 0, 0),"+
				"('KENYA SEED CO. LTD', 50, 0, 0, 0),"+
				"('KENYA SEED CO. LTD', 51, 0, 0, 0),"+
				"('KENYA SEED CO. LTD', 52, 0, 0, 0),"+
				"('KENYA SEED CO. LTD', 53, 0, 0, 0),"+
				"('LAGROTECH SEED', 55, 0, 0, 0),"+
				"('LELDET LTD', 56, 0, 0, 0),"+
				"('LELDET LTD', 57, 0, 0, 0),"+
				"('MASENO UNIVERSITY', 58, 0, 0, 0),"+
				"('MONSANTO KENYA LTD', 59, 0, 0, 0),"+
				"('MONSANTO KENYA LTD', 60, 0, 0, 0),"+
				"('MONSANTO KENYA LTD', 61, 0, 0, 0),"+
				"('NASECO', 62, 0, 0, 0),"+
				"('NATIONAL IRRIGATION BOARD', 63, 0, 0, 0),"+
				"('NONE', 64, 0, 0, 0),"+
				"('OIL CROP DEVELOPMENT', 66, 0, 0, 0),"+
				"('OLERAI', 67, 0, 0, 0),"+
				"('OREAN', 68, 0, 0, 0),"+
				"('OREON', 69, 0, 0, 0),"+
				"('PANNAR SEED COMPANY', 70, 0, 0, 0),"+
				"('PIONEER HI-BRED KENYA LIMITED ', 71, 0, 0, 0),"+
				"('SACRED', 72, 0, 0, 0),"+
				"('SEEDCO-KENYA', 73, 0, 0, 0),"+
				"('SIMLAW SEEDS', 74, 0, 0, 0),"+
				"('UNIVERSITY OF NAIROBI', 75, 0, 0, 0),"+
				"('VET AGRO', 76, 0, 0, 0),"+
				"('VICTORIA', 77, 0, 0, 0),"+
				"('WAKALA', 78, 0, 0, 0),"+
				"('WESTERN SEED COMPANY LTD', 79, 0, 0, 0),"+
				"('WESTERN SEED COMPANY LTD', 80, 0, 0, 0),"+
				"('EAST AFRICAN SEED CO LTD', 81, 0, 0, 0);";
		...
		tx.executeSql(alt_regions_sql, [], function (tx, results) {
		  	...
		  	for (i = 0; i < length; i++) {
		  		...
		  		if (results.rows.item(i).lowland !== null) {
					altitude_regions['lowland']='Coastal or Dryland';
					
				}else if (results.rows.item(i).lowland_transitional !== null) {
					altitude_regions['lowland_transitional']='Dryland to Mid Altitude Transitional';
					
				}else if (results.rows.item(i).mid_altitude !== null) {
					altitude_regions['mid_altitude']='Mid Altitude';
					
				}else if (results.rows.item(i).highland_transitional !== null) {
					altitude_regions['highland_transitional']='Mid Altitude to Highland Transitional';
					
				}else if (results.rows.item(i).highland !== null) {
					altitude_regions['highland']='Highland';
				}
		  	}

			for ( var key in altitude_regions ){
				$("#altitude_regions_english").append('<option value="'+key+'">'+altitude_regions[key]+'</option>');
				// console.log(key);
			}
	...
	db.transaction(function(tx){
		...
		tx.executeSql(alt_regions_sql, [], function (tx, results) {
		  	...
		  	for (i = 0; i < length; i++) {
		  		...
		  		if (results.rows.item(i).lowland !== null) {
					altitude_regions['lowland']='Nyanda ya Chini';
					
				}else if (results.rows.item(i).lowland_transitional !== null) {
					altitude_regions['lowland_transitional']='Nyanda ya Chini Kiasi';
					
				}else if (results.rows.item(i).mid_altitude !== null) {
					altitude_regions['mid_altitude']='Muinuko Kiasi';
					
				}else if (results.rows.item(i).highland_transitional !== null) {
					altitude_regions['highland_transitional']='Nyanda ya Juu Kiasi';
					
				}else if (results.rows.item(i).highland !== null) {
					altitude_regions['highland']='Nyanda ya Juu';
				}
		  	}

			for ( var key in altitude_regions ){
				$("#altitude_regions_swahili").append('<option value="'+key+'">'+altitude_regions[key]+'</option>');
			}
			...
			tx.executeSql(all_crops_details_sql, [], function (tx, results) {
			  	...
			  	if(length >= 1){
				  	...
				  	for (i = 0; i < length; i++) {
						...
						var sw_comm_agents_names = comm_agents_names[sw_id].agents.join(',');
						...
						// fetched_crop_data.push(JSON.stringify(crop_data));
						if($.inArray(results.rows.item(i).sw_id, sw_ids) > -1){
							fetched_crops.pop();
...
function sync_with_live_db () {
	...
	$.ajax({
		async: true,
	    type: "GET",
	    url: "http://mbeguchoice.com/swahili/mbegu_choice/get_mobile_app_sync_data",
	    dataType: "json"
	}).done(function( sync_data, textStatus, jqXHR ) {
        ...
        db.transaction(
			function(tx) {		
				tx.executeSql('SELECT crop_id FROM default_sid_crop_swa order by crop_id asc', [], function (tx, results) {
				  	var length = results.rows.length, i;
				  	for (i = 0; i < length; i++) {
				    	appdb_crop_ids.push(results.rows.item(i).crop_id);
				  	}
        ...
        db.transaction(
			function(tx) {
				var truncate_cropstable_sql = "DROP TABLE IF EXISTS default_sid_crop_swa;";
				tx.executeSql(truncate_cropstable_sql);

				var create_cropstable_sql = "CREATE TABLE IF NOT EXISTS default_sid_crop_swa ( "+
					"crop_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
					"crop_name varchar(255), " + 
					"category_id INTEGER(11) " + 
				");";
		...
		$.each( crops, function( i, crop ) {
	        db.transaction(
				function(tx) {
					...
					var insert_crops_sql = 'INSERT OR IGNORE INTO default_sid_crop_swa (crop_id, crop_name, category_id) VALUES '+
					'("'+crop.crop_id+'", "'+crop_name+'", '+crop.category_id+');';
					tx.executeSql(insert_crops_sql);
				},
				function(error){console.dir(error);}
        ...
        db.transaction(
			function(tx) {		
				tx.executeSql('SELECT category_id FROM default_sid_cropcategory_swa order by category_id asc', [], function (tx, results) {
				  	var length = results.rows.length, i;
				  	for (i = 0; i < length; i++) {
				    	appdb_cropcategories_ids.push(results.rows.item(i).category_id);
				  	}
		...
		$.each( cropcategories, function( i, cropcategory ) {
	        db.transaction(
				function(tx) {
					...
					if(cropcategory.category_id == appdb_cropcategories_ids[i]){
						var update_cropcategories_sql = 'UPDATE default_sid_cropcategory_swa SET category_name ="'+category_name+'"'+' WHERE category_id ='+cropcategory.category_id+';';
						tx.executeSql(update_cropcategories_sql);
						
					}else{
						var insert_cropcategories_sql = 'INSERT OR IGNORE INTO default_sid_cropcategory_swa (category_id, category_name) VALUES '+
						'(NULL, "'+category_name+'"'+');';
						tx.executeSql(insert_cropcategories_sql);
					}
				},
        ...
        db.transaction(
			function(tx) {		
				tx.executeSql('SELECT sw_id FROM default_sid_seedchoice_seedworks_combined_swa order by sw_id asc', [], function (tx, results) {
				  	var length = results.rows.length, i;
				  	for (i = 0; i < length; i++) {
				    	appdb_cropvarieties_ids.push(results.rows.item(i).sw_id);
				  	}
		...
		db.transaction(
			function(tx) {
				var truncate_cropsvarietiestable_sql = "DROP TABLE IF EXISTS default_sid_seedchoice_seedworks_combined_swa;";
				tx.executeSql(truncate_cropsvarietiestable_sql);

				var create_cropsvarietiestable_sql = "CREATE TABLE IF NOT EXISTS default_sid_seedchoice_seedworks_combined_swa ( "+
					"sw_id INTEGER PRIMARY KEY AUTOINCREMENT,"+
					"sw_variety varchar(255),"+
					"category_id INTEGER(11),"+
					"crop_id INTEGER(11),"+
		...
		$.each( cropvarieties, function( i, cropvariety ) {
	        db.transaction(
				function(tx) {
					...
					var insert_cropvarieties_sql = 'INSERT OR IGNORE INTO default_sid_seedchoice_seedworks_combined_swa (sw_id, sw_variety, category_id, crop_id, seedtype_id, season_id, license_type_id, comm_potential_id, comm_level_id, sw_releaseyr, sw_breed_institution, sw_maintainer, sw_comm_agent, sw_alt_optimal, sw_alt_min, sw_alt_max, sw_maturity, sw_maturity_age, sw_special_attrib, sw_drought_tolerant, sw_disease_tolerant, sw_storage_pest_resistant, sw_consumer_preferences, county, lowland, lowland_transitional, mid_altitude, highland_transitional, highland) VALUES '+
					'("'+cropvariety.sw_id+'", "'+cropvariety.sw_variety+'", "'+cropvariety.category_id+'", "'+cropvariety.crop_id+'", "'+cropvariety.seedtype_id+'", "'+cropvariety.season_id+'", "'+cropvariety.license_type_id+'", "'+cropvariety.comm_potential_id+'", "'+cropvariety.comm_level_id+'", "'+cropvariety.sw_releaseyr+'", "'+cropvariety.sw_breed_institution+'", "'+cropvariety.sw_maintainer+'", "'+cropvariety.sw_comm_agent+'", "'+cropvariety.sw_alt_optimal+'", "'+cropvariety.sw_alt_min+'", "'+cropvariety.sw_alt_max+'", "'+cropvariety.sw_maturity+'", "'+cropvariety.sw_maturity_age+'", "'+cropvariety.sw_special_attrib+'", "'+cropvariety.sw_drought_tolerant+'", "'+cropvariety.sw_disease_tolerant+'", "'+cropvariety.sw_storage_pest_resistant+'", "'+cropvariety.sw_consumer_preferences+'", "'+cropvariety.county+'", "'+cropvariety.lowland+'", "'+cropvariety.lowland_transitional+'", "'+cropvariety.mid_altitude+'", "'+cropvariety.highland_transitional+'", "'+cropvariety.highland+'"'+');';
					tx.executeSql(insert_cropvarieties_sql);
				},
				function(error){console.dir(error);}
	    ...
	    var err = textStatus + ", " + error;
		console.dir( "Request Failed for Swahili: " + err );
	});
